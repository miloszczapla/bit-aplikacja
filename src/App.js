    ...
    <>
      ...
      <Section side='right' topic='Motywacja' img='motivation.jpg'>
        <p>
          ...
          Oprócz tego integracja na całego ze wspaniałym CT jest zawsze kozacka.
          Zdobywanie doświadczenia od bardziej doświadczonych ludzi trzyma mnie
          najbardziej w projekcie, patrząc na nich, wiem, ile jeszcze mogę się
          dowiedzieć i co osiągnąć.
        </p>
      </Section>
      <Section side='left' topic='Dostępność' img='clock.png'>
        <p>
          Jest szansa, że pomiędzy 16 a 25 lipca wyjadę na BEST courses, oprócz
          tego planów aktualnie brak, więc mogę być cały wasz, cały wasz.
        </p>
      </Section>
      ...
      <Section side='left' topic='Dlaczego BIT' img='logo.webp'>
        <p>
          ...
          mi się spodobało, to co wam się udało zrobić i chętnie w tym roku będę
          razem z całym CT tworzył coś jeszcze lepszego niż w poprzednim. Podoba
          mi się też połączenie świetnej zabawy i wartościowej wiedzy w jednej
          tematyce na jednym wydarzeniu. Myślę, że dodaje to dynamizmu całości.
          Też tematyka gier nie jest mi obca i, mimo że już mało spędzam czasu
          na gierkach komputerowych to duży mam do nich, jak i graczy sentyment.
          Przesiadłem się na planszówki (integracja? Wink, wink)
        </p>
      </Section>
